...
void default_mra_dfs_f (char** mra_dfs_matrix, size_t chunks, size_t workers_mra, int replicas)
{
 ...
 //   size_t  owner;
    ...
    */ 
    	...
    	/* Reduz 1 chunk da distribuição e recalcula Novamente prev_exe, temp_corr e soma_dist       	 */
      ...
      */
      ...
      /* 
        * @avg_task_exec_map -  Média dos tempos de execuções da tarefas MAP do grupo.             */
